  ...
  return (
    <Layout>
      ...
      <section className="relative min-h-[60vh] flex items-center justify-start overflow-hidden">
        ...
        <div className="relative z-10 container flex flex-col justify-center items-start h-full pl-8 py-16">
          <motion.h1
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.1 }}
            className="font-display text-white text-5xl md:text-7xl font-medium max-w-3xl leading-tight mb-8 text-left drop-shadow-lg"
          >
          ...
          >
            ...
            <Button asChild variant="heroOutline" size="xl" className="border-white text-white bg-white/20 hover:bg-white/40 hover:text-foreground">
              <Link to="/shop">
                Shop TheMOOVBook™
              </Link>
            </Button>
